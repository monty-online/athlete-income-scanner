// Netlify serverless function — keeps the Anthropic API key on the server side.
// Reads ANTHROPIC_API_KEY from Netlify's environment variables (set in Site settings).
